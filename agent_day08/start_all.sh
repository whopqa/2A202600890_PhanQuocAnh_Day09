...
python -m agent_day08.day08_registry &
REGISTRY_PID=$!
sleep 2

echo "Starting Day08 legal RAG agent on port 11012..."
python -m agent_day08.day08_legal_rag_agent &
LEGAL_PID=$!

echo "Starting Day08 news RAG agent on port 11013..."
python -m agent_day08.day08_news_rag_agent &
NEWS_PID=$!
sleep 3

echo "Starting Day08 orchestrator on port 11011..."
python -m agent_day08.day08_orchestrator_agent &
ORCH_PID=$!
sleep 3

echo "Starting Day08 customer agent on port 11010..."
python -m agent_day08.day08_customer_agent &
CUSTOMER_PID=$!

echo "Starting Day08 UI on port 11014..."
python -m agent_day08.day08_ui &
UI_PID=$!
...
echo "  python -m agent_day08.test_client"
echo ""
